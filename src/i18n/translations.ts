...
export const translations = {
  ...
  en: {
    ...
    backTop: 'Back to top',
    colophon: 'Designed & coded in Paris.',
...
export const PROJECTS = [
  ...
  { name: { fr: 'Gambit', en: 'Gambit' }, blurb: { fr: 'Une application PWA d\'échecs pour deux joueurs partageant un seul appareil — asseyez-vous l\'un en face de l\'autre, et jouez avec un seul téléphone (ou tablette)', en: 'A pass-and-play chess PWA for two players sharing one device — sit across from each other, prop up the phone (or tablet)' }, href: 'https://chess.yoann-k.com/', img: "/projects/gambit.jpg" },
